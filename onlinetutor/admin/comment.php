...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $user_id = $_SESSION['admin_id']; // You would normally get this from a session or authentication system
  ...
  if (mysqli_stmt_execute($stmt)) {
    ...
    header("Location: adminvideo.php?id=$video_id");
  } else {
...
header("Location: adminvideo.php?id=$v_id");
}
?>