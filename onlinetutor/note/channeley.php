...
?>
    ...
    <a class="box" href="adminwatch-video.php?id=<?php echo $row['video_id']; ?>">
      <div class="tutor">
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE video SET total = (SELECT COUNT(*) FROM video) WHERE video_id = $video_id";
  header("Location: channeley.php?id=$channel_id");
  exit;
}
?>
