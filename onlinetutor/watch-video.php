...
while ($comment = mysqli_fetch_assoc($comments_result)) {
  // Output the comment text, user who made the comment, and creation date
   ...
   <div class="box-container">
      ...
      <div class="box">
         <div class="user">
            <img src= "admin/img/<?php echo $comment['image']; ?>" alt="">
            <div>
...
<?php
 ...
 $query2 = "SELECT c.*, u.name,u.image FROM comments c 
 JOIN userform u ON c.user_id = u.id 
 WHERE c.parent_id =" . $comment['id'] . " ORDER BY c.created_at DESC"; 
 ...
 if ($result2) {
   while ($reply = mysqli_fetch_assoc($result2)) {
      ...
      <h1 class="heading">user replys</h1>
         <div class="user">
            <img src= "admin/img/<?php echo $reply['image']; ?>" alt="">
            <div>
